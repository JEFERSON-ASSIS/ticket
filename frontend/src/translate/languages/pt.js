    ...
    translations: {
      ...
      mainDrawer: {
        listItems: {
          ...
          Envio: "Envio Automático",
          Media: "Envio de Mídia",
          Groups: "Grupos",
          Direct: "Direct IG",
          SMS: "SMS",
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os tickets desse setor continuarão existindo, mas não terão mais nenhuma setor atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Setores",
